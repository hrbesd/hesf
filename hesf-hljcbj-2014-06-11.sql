...
) ENGINE=InnoDB AUTO_INCREMENT=5465 DEFAULT CHARSET=utf8 COMMENT='		';
...
insert  into `audit_process_status`(`id`,`audit_process_status`,`create_time`,`update_time`,`user_id`,`is_active`,`version`,`priority`,`remark`) values (1,'未初审',now(),now(),1,0,1,'1','公用'),(2,'已初审 未复审',now(),now(),1,1,1,'2','农垦保障金使用'),(3,'已复审 未缴款',now(),now(),1,0,1,'6','省残联保障金使用'),(4,'部分缴款',now(),now(),1,0,1,'7','省残联保障金使用'),(5,'已缴款',now(),now(),1,0,1,'8','省残联保障金使用'),(6,'达标',now(),now(),1,0,1,'9','公用'),(7,'已复审 未通过',now(),now(),1,0,1,'4','公用'),(8,'已复审 未终审',now(),now(),1,1,1,'8','农垦保障金使用'),(9,'已终审 未通过',now(),now(),1,1,1,'9','农垦保障金使用'),(10,'终审完成',now(),now(),1,1,1,'10','农垦保障金使用'),(11,'已初审 未减免',now(),now(),1,0,1,'2','省残联保障金使用'),(12,'已减免 未复审',now(),now(),1,0,1,'5','省残联保障金使用'),(13,'已减免 未通过',now(),now(),1,0,1,'3','省残联保障金使用');
...
insert  into `company_economy_type`(`id`,`company_economy_type`,`create_time`,`update_time`,`is_active`,`user_id`,`version`) values (1,'国有',now(),now(),0,1,1),(2,'集体',now(),now(),0,1,1),(3,'私营',now(),now(),0,1,1),(4,'个体',now(),now(),0,1,1),(5,'联营',now(),now(),0,1,1),(6,'股份制',now(),now(),0,1,1),(7,'外商投资',now(),now(),0,1,1),(8,'港澳台投资',now(),now(),0,1,1),(9,'其他',now(),now(),0,1,1);
...
insert  into `company_property`(`id`,`company_property`,`create_time`,`update_time`,`is_active`,`user_id`,`version`,`remark`) values (1,'中直企业',now(),now(),0,1,1,'省残联保障金使用'),(2,'省直企业',now(),now(),0,1,1,'省残联保障金使用'),(3,'机关事业单位',now(),now(),0,1,1,'省残联保障金使用'),(4,'机关',now(),now(),1,1,1,'农垦保障金使用'),(5,'企事业单位',now(),now(),1,1,1,'农垦保障金使用'),(6,'省直/局直单位',now(),now(),1,1,1,'农垦保障金使用');
...
insert  into `company_type`(`id`,`company_type`,`create_time`,`update_time`,`is_active`,`user_id`,`version`) values (1,'企业',now(),now(),0,1,1),(2,'事业',now(),now(),0,1,1),(3,'机关',now(),now(),0,1,1),(4,'机关团体',now(),now(),0,1,1);
...
insert  into `menu`(`primary_key`,`id`,`text`,`remark`,`iconcls`,`state`,`url`,`checked`,`user_id`,`is_active`,`permission_type_id`,`create_time`,`update_time`,`version`) values (122,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,1,now(),now(),1),(123,'10020000','退出',NULL,'','','/quit','false',1,0,1,now(),now(),1),(124,'20010100','基本档案',NULL,'icon-fold','open','','false',1,0,1,now(),now(),1),(125,'20010200','初审管理',NULL,'icon-fold','open',NULL,'false',1,0,7,now(),now(),1),(126,'20010400','复审管理',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(127,'20010600','缴款管理',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(128,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,6,now(),now(),1),(129,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(130,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,2,now(),now(),1),(131,'20011000','系统设置',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(135,'30010201','年审单位初审',NULL,NULL,NULL,'audits/list/1','',1,0,1,now(),now(),1),(136,'30010401','年审单位复审',NULL,NULL,NULL,'audits/list/12','',1,0,1,now(),now(),1),(137,'30010601','企业缴款列表',NULL,NULL,NULL,'payment/list/3','',1,0,1,now(),now(),1),(138,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,6,now(),now(),1),(139,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,6,now(),now(),1),(140,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,6,now(),now(),1),(141,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,6,now(),now(),1),(142,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,2,now(),now(),1),(143,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,2,now(),now(),1),(144,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,2,now(),now(),1),(145,'30011001','年审参数列表',NULL,NULL,NULL,'settings/yearAuditParameter',NULL,1,0,1,now(),now(),1),(146,'30011002','用户设置列表',NULL,NULL,NULL,'settings/user',NULL,1,0,1,now(),now(),1),(148,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,2,now(),now(),1),(149,'10020000','退出',NULL,'','','/quit','false',1,0,2,now(),now(),1),(150,'20010100','基本档案',NULL,'icon-fold','open','','false',1,0,2,now(),now(),1),(155,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,2,now(),now(),1),(156,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,3,now(),now(),1),(161,'30010201','年审单位初审',NULL,NULL,NULL,'audits/list/1','',1,0,2,now(),now(),1),(168,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,3,now(),now(),1),(169,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,3,now(),now(),1),(170,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,3,now(),now(),1),(179,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,3,now(),now(),1),(180,'10020000','退出',NULL,'','','/quit','false',1,0,3,now(),now(),1),(181,'20010100','基本档案',NULL,'icon-fold','open','','false',1,0,3,now(),now(),1),(186,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,3,now(),now(),1),(187,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,4,now(),now(),1),(193,'30010401','年审单位复审',NULL,NULL,NULL,'audits/list/12','',1,0,3,now(),now(),1),(199,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,4,now(),now(),1),(200,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,4,now(),now(),1),(201,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,4,now(),now(),1),(205,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,4,now(),now(),1),(206,'10020000','退出',NULL,'','','/quit','false',1,0,4,now(),now(),1),(210,'20010600','缴款管理',NULL,'icon-fold','open',NULL,'false',1,0,4,now(),now(),1),(212,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,4,now(),now(),1),(213,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,6,now(),now(),1),(220,'30010601','企业缴款列表',NULL,NULL,NULL,'payment/list/3','',1,0,4,now(),now(),1),(225,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,6,now(),now(),1),(226,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,6,now(),now(),1),(227,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,6,now(),now(),1),(228,'30010602','部分缴款列表',NULL,NULL,NULL,'payment/list/4',NULL,1,0,1,now(),now(),1),(229,'30010602','部分缴款列表',NULL,NULL,NULL,'payment/list/4',NULL,1,0,4,now(),now(),1),(230,'30010203','已复审未通过',NULL,NULL,NULL,'audits/list/7',NULL,1,0,1,now(),now(),1),(231,'30010203','已复审未通过',NULL,NULL,NULL,'audits/list/7',NULL,1,0,2,now(),now(),1),(232,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,6,now(),now(),1),(236,'30011003','复审意见设置',NULL,NULL,NULL,'settings/reply',NULL,1,0,1,now(),now(),1),(240,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,6,now(),now(),1),(241,'30010104','机关','农垦保障金使用',NULL,NULL,'company/list/4',NULL,0,1,6,now(),now(),1),(242,'30010105','企事业单位','农垦保障金使用',NULL,NULL,'company/list/5',NULL,0,1,6,now(),now(),1),(243,'30010106','省直/局直单位','农垦保障金使用',NULL,NULL,'company/list/6',NULL,0,1,6,now(),now(),1),(245,'30010501','年审单位终审','农垦保障金使用',NULL,NULL,'audits/list/8',NULL,1,1,6,now(),now(),1),(246,'20010500','终审管理','农垦保障金使用','icon-fold','open',NULL,'false',1,1,6,now(),now(),1),(247,'30010205','已终审未通过','农垦保障金使用',NULL,NULL,'audits/list/9',NULL,1,1,2,now(),now(),1),(248,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,6,now(),now(),1),(249,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,7,now(),now(),1),(250,'10020000','退出',NULL,'','','/quit','false',1,0,6,now(),now(),1),(251,'10020000','退出',NULL,'','','/quit','false',1,0,7,now(),now(),1),(252,'20010100','基本档案',NULL,'icon-fold','open',NULL,'false',1,0,6,now(),now(),1),(256,'30010101','中直企业',NULL,NULL,NULL,'company/list/1','',1,0,1,now(),now(),1),(257,'30010102','省直企业',NULL,NULL,NULL,'company/list/2','',1,0,1,now(),now(),1),(258,'30010103','机关事业单位',NULL,NULL,NULL,'company/list/3','',1,0,1,now(),now(),1),(259,'30010101','中直企业',NULL,NULL,NULL,'company/list/1','',1,0,2,now(),now(),1),(260,'30010102','省直企业',NULL,NULL,NULL,'company/list/2','',1,0,2,now(),now(),1),(261,'30010103','机关事业单位',NULL,NULL,NULL,'company/list/3','',1,0,2,now(),now(),1),(268,'30010101','中直企业',NULL,NULL,NULL,'company/list/1','',1,0,3,now(),now(),1),(269,'30010102','省直企业',NULL,NULL,NULL,'company/list/2','',1,0,3,now(),now(),1),(270,'30010103','机关事业单位',NULL,NULL,NULL,'company/list/3','',1,0,3,now(),now(),1),(271,'30010101','中直企业',NULL,NULL,NULL,'company/list/1','',1,0,6,now(),now(),1),(272,'30010102','省直企业',NULL,NULL,NULL,'company/list/2','',1,0,6,now(),now(),1),(273,'30010103','机关事业单位',NULL,NULL,NULL,'company/list/3','',1,0,6,now(),now(),1),(299,'30010104','机关','农垦保障金使用',NULL,NULL,'company/list/4',NULL,1,1,1,now(),now(),1),(300,'30010105','企事业单位','农垦保障金使用',NULL,NULL,'company/list/5',NULL,1,1,1,now(),now(),1),(301,'30010106','省直/局直单位','农垦保障金使用',NULL,NULL,'company/list/6',NULL,1,1,1,now(),now(),1),(302,'30010104','机关','农垦保障金使用',NULL,NULL,'company/list/4',NULL,1,1,2,now(),now(),1),(303,'30010105','企事业单位','农垦保障金使用',NULL,NULL,'company/list/5',NULL,1,1,2,now(),now(),1),(304,'30010106','省直/局直单位','农垦保障金使用',NULL,NULL,'company/list/6',NULL,1,1,2,now(),now(),1),(305,'30010104','机关','农垦保障金使用',NULL,NULL,'company/list/4',NULL,1,1,3,now(),now(),1),(306,'30010105','企事业单位','农垦保障金使用',NULL,NULL,'company/list/5',NULL,1,1,3,now(),now(),1),(307,'30010106','省直/局直单位','农垦保障金使用',NULL,NULL,'company/list/6',NULL,1,1,3,now(),now(),1),(309,'30010204','公司信息录入','农垦保障金使用',NULL,NULL,'company/list/luru',NULL,1,1,1,now(),now(),1),(310,'30010205','已终审未通过','农垦保障金使用',NULL,NULL,'audits/list/9',NULL,1,1,1,now(),now(),1),(315,'20010200','初审管理',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(316,'20010200','初审管理',NULL,'icon-fold','open',NULL,'false',1,0,2,now(),now(),1),(318,'30010204','公司信息录入','农垦保障金使用',NULL,NULL,'company/list/luru',NULL,1,1,2,now(),now(),1),(319,'30010204','公司信息录入','农垦保障金使用',NULL,NULL,'company/list/luru',NULL,1,1,7,now(),now(),1),(321,'20010500','终审管理','农垦保障金使用','icon-fold','open',NULL,'false',1,1,1,now(),now(),1),(322,'30010501','年审单位终审','农垦保障金使用',NULL,NULL,'audits/list/8',NULL,1,1,1,now(),now(),1),(323,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(324,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,2,now(),now(),1),(325,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,3,now(),now(),1),(326,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,4,now(),now(),1),(330,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,1,now(),now(),1),(331,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,2,now(),now(),1),(332,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,3,now(),now(),1),(333,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,4,now(),now(),1),(337,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,1,now(),now(),1),(338,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,1,now(),now(),1),(339,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,1,now(),now(),1),(340,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,2,now(),now(),1),(341,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,2,now(),now(),1),(342,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,2,now(),now(),1),(343,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,3,now(),now(),1),(344,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,3,now(),now(),1),(345,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,3,now(),now(),1),(346,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,4,now(),now(),1),(347,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,4,now(),now(),1),(348,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,4,now(),now(),1),(349,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,1,now(),now(),1),(350,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,2,now(),now(),1),(351,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,3,now(),now(),1),(352,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,4,now(),now(),1),(368,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(369,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,1,now(),now(),1),(370,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,1,now(),now(),1),(371,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,1,now(),now(),1),(372,'20010300','减免缓管理','黑龙江省残联残保金使用','icon-fold','open',NULL,'false',1,0,1,now(),now(),1),(373,'20010300','减免缓管理','黑龙江省残联残保金使用','icon-fold','open',NULL,'false',1,0,8,now(),now(),1),(374,'30010301','年审单位减免缓','黑龙江省残联残保金使用','','','audits/list/11','',1,0,1,now(),now(),1),(375,'30010301','年审单位减免缓','黑龙江省残联残保金使用','','','audits/list/11','',1,0,8,now(),now(),1),(376,'30010202','已减免未通过','黑龙江省残联残保金使用',NULL,NULL,'audits/list/13','',1,0,1,now(),now(),1),(377,'30010202','已减免未通过','黑龙江省残联残保金使用',NULL,NULL,'audits/list/13','',1,0,2,now(),now(),1),(378,'20010900','统计报表',NULL,'icon-fold','open',NULL,'false',1,0,8,now(),now(),1),(379,'30010901','年审情况汇总表(单位性质)',NULL,NULL,NULL,'report/nature',NULL,1,0,8,now(),now(),1),(380,'30010902','年审情况汇总表(地区)',NULL,NULL,NULL,'report/area',NULL,1,0,8,now(),now(),1),(381,'30010903','年审情况汇总表(经济类型)',NULL,NULL,NULL,'report/economytype',NULL,1,0,8,now(),now(),1),(382,'10010000','保障金菜单',NULL,'icon-fold','open','','false',1,0,8,now(),now(),1),(383,'10020000','退出',NULL,'','','/quit','false',1,0,8,now(),now(),1),(384,'20010100','基本档案',NULL,'icon-fold','open','','false',1,0,8,now(),now(),1),(386,'20010800','查询统计',NULL,'icon-fold','open',NULL,'false',1,0,8,now(),now(),1),(388,'30010101','中直企业',NULL,NULL,NULL,'company/list/1','',1,0,8,now(),now(),1),(389,'30010102','省直企业',NULL,NULL,NULL,'company/list/2','',1,0,8,now(),now(),1),(390,'30010103','机关事业单位',NULL,NULL,NULL,'company/list/3','',1,0,8,now(),now(),1),(391,'30010104','机关','农垦保障金使用',NULL,NULL,'company/list/4',NULL,1,1,8,now(),now(),1),(392,'30010105','企事业单位','农垦保障金使用',NULL,NULL,'company/list/5',NULL,1,1,8,now(),now(),1),(393,'30010106','省直/局直单位','农垦保障金使用',NULL,NULL,'company/list/6',NULL,1,1,8,now(),now(),1),(394,'20010700','文书管理',NULL,'icon-fold','open',NULL,'false',1,0,8,now(),now(),1),(395,'30010701','打印列表',NULL,NULL,NULL,'print/list','',1,0,8,now(),now(),1),(396,'30010801','单位档案查询',NULL,NULL,NULL,'query/company/list',NULL,1,0,8,now(),now(),1),(397,'30010802','单位年审查询',NULL,NULL,NULL,'query/audit/list',NULL,1,0,8,now(),now(),1),(398,'30010803','残疾职工查询',NULL,NULL,NULL,'query/worker/list',NULL,1,0,8,now(),now(),1),(399,'30010804','缴款记录查询',NULL,NULL,NULL,'query/payment/list',NULL,1,0,8,now(),now(),1),(409,'20010400','复审管理',NULL,'icon-fold','open',NULL,'false',1,0,3,now(),now(),1),(410,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,2,now(),now(),1),(411,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,3,now(),now(),1),(412,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,4,now(),now(),1),(413,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,6,now(),now(),1),(414,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,7,now(),now(),1),(415,'20011000','系统设置',NULL,'icon-fold',NULL,NULL,'false',1,0,8,now(),now(),1),(416,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,1,now(),now(),1),(417,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,2,now(),now(),1),(418,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,3,now(),now(),1),(419,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,4,now(),now(),1),(420,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,6,now(),now(),1),(421,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,7,now(),now(),1),(422,'30011004','修改密码',NULL,NULL,NULL,'settings/user/pwdedit','',1,0,8,now(),now(),1);
...
insert  into `payment_type`(`id`,`text`,`create_time`,`update_time`,`user_id`,`is_active`) values (1,'残联自收',now(),now(),NULL,1),(2,'地税代征',now(),now(),NULL,1);
...
insert  into `permission_type`(`id`,`permission_type`,`create_time`,`update_time`,`user_id`,`is_active`,`version`,`remark`) values (1,'超级管理员',now(),now(),1,0,1,NULL),(2,'初审',now(),now(),1,0,1,NULL),(3,'复审',now(),now(),1,0,1,NULL),(4,'缴款',now(),now(),1,0,1,'黑龙江省残联残保金使用'),(5,'查询',now(),now(),1,0,1,'黑龙江省残联残保金使用'),(6,'终审',now(),now(),1,0,1,'农垦保障金使用'),(7,'录入',now(),now(),1,0,1,'农垦保障金使用'),(8,'减免缓',now(),now(),1,0,1,'黑龙江省残联残保金使用');
...
insert  into `reply`(`id`,`title`,`content`,`create_time`,`update_time`,`user_id`,`is_active`,`version`) values (1,'无','',now(),now(),0,0,4),(2,'年龄超标','存在年龄超标的残疾人员工',now(),now(),0,0,3),(5,'预定人数过多','预定人数过多',now(),now(),0,0,2),(7,'金额计算问题','金额计算有问题',now(),now(),0,0,2),(14,'安排人数问题','安排人数存在问题。确认人数是否正确',now(),now(),0,0,2);
...
insert  into `user`(`id`,`user_name`,`user_real_name`,`user_password`,`user_email`,`user_mobile`,`user_phone`,`user_group_id`,`user_status`,`create_time`,`update_time`,`user_id`,`is_active`,`version`,`user_remark`) values (1,'admin','管理员','d138768d3b5eca407f0dd579c5ca3767',NULL,'15846538450',NULL,1,1,now(),now(),0,0,6,''),(2,'chushen','初审专家','b71cf3839f16f4e828d2a946e5af551f',NULL,'12321321',NULL,2,1,now(),now(),0,0,3,''),(3,'fushen','复审专家','417e03278b3417e6e863f296ad6d288d',NULL,'1232321',NULL,3,1,now(),now(),0,0,2,''),(4,'jiaokuan','缴款专家','3acfb9cafa6a27d56c38fd30988d62b1',NULL,'12321321321',NULL,4,1,now(),now(),0,0,3,''),(5,'chaxun','查询专家','6fba6418627a2a1dfd7f8643a94324d6',NULL,'13812345678',NULL,5,1,now(),now(),0,0,1,''),(6,'jianmian','减免专家','f5720f216ef7458307844bc4301ee420',NULL,'1381352458',NULL,8,1,now(),now(),NULL,0,1,''),(7,'lufeng','lufeng','706f61a443a2f777788430def71a636a',NULL,'111',NULL,2,1,now(),now(),NULL,0,1,''),(8,'jiaoyang','焦阳','dea2a34eacf853b7b8c062b5f2212930',NULL,'123',NULL,3,1,now(),now(),NULL,0,2,''),(9,'zhangbei','zhangbei','bb22b1ad701cdda350f2b027761e7b5c',NULL,'12313',NULL,2,1,now(),now(),NULL,0,1,''),(10,'tianjing','tianjing','c61e8240cfa3a4b91611c7e7e75ce152',NULL,'12312',NULL,4,1,now(),now(),NULL,0,1,''),(11,'dishuiju','地税局','73b996c12093b38aab04dce1ba497043',NULL,'1234',NULL,4,1,now(),now(),NULL,0,2,'');
...
insert  into `user_group`(`id`,`permission_type_id`,`user_group_name`,`create_time`,`update_time`,`user_id`,`is_active`,`version`,`remark`) values (1,1,'超级管理员组',now(),now(),1,1,1,NULL),(2,2,'初审用户组',now(),now(),1,0,1,NULL),(3,3,'复审用户组',now(),now(),1,0,1,NULL),(4,4,'缴款用户组',now(),now(),1,0,1,'省残联保障金使用'),(5,5,'查询用户组',now(),now(),1,0,1,'省残联保障金使用'),(6,6,'终审用户组',now(),now(),1,1,1,'农垦保障金使用'),(7,7,'录入用户组',now(),now(),1,1,1,'农垦保障金使用'),(8,8,'减免用户组',now(),now(),1,0,1,'黑龙江省残联残保金使用');
...
CREATE TABLE `worker` (
  ...
  `pic` mediumblob COMMENT '精神残疾人员上传的图片',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '0' COMMENT '是否逻辑删除: 0--no(即未被删除), 1--yes(即被删除)',
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='职工表';
...
insert  into `worker_handicap_level`(`id`,`handicap_level`,`create_time`,`update_time`,`user_id`,`is_active`,`version`) values (1,'一级',now(),now(),1,0,1),(2,'二级',now(),now(),1,0,1),(3,'三级',now(),now(),1,0,1),(4,'四级',now(),now(),1,0,1);
...
insert  into `worker_handicap_type`(`id`,`handicap_type`,`create_time`,`update_time`,`user_id`,`is_active`,`version`) values (1,'视力残疾',now(),now(),1,0,1),(2,'听力残疾',now(),now(),1,0,1),(3,'言语残疾',now(),now(),1,0,1),(4,'肢体残疾',now(),now(),1,0,1),(5,'智力残疾',now(),now(),1,0,1),(6,'精神残疾',now(),now(),1,0,1),(7,'多重残疾',now(),now(),1,0,1);
