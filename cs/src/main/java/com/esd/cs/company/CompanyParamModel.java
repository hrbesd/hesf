...
public class CompanyParamModel extends PrimaryKey_String {
	...
	public String toString() {
		return "CompanyParamModel [year=" + year + ", companyCode="
				...
				+ area + ", firstTime=" + firstTime + ", companyEmpTotal_1="
				+ companyEmpTotal_1 + ", companyEmpTotal_2="
				+ companyEmpTotal_2 + ", companyName=" + companyName
				+ ", companyAddress=" + companyAddress + ", companyLegal="
				+ companyLegal + ", companyHandicapTotal_1="
				+ companyHandicapTotal_1 + ", companyHandicapTotal_2="
				+ companyHandicapTotal_2 + ", isDownLoadAll=" + isDownLoadAll
				+ ", page=" + page + ", rows=" + rows + "]";
	}
