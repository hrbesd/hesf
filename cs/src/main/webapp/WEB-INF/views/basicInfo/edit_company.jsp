...
<!-- 数据表格 -->
<table id="edit_companyTab" class="company_info" style="margin-top: 20px;margin-left: 90px;" border="0">
	<tr>
	...
	<tr>
		...
		<td class="bj_belu">
		<input  value="${company.companyType.id}"  id="companyType"  name="companyType.id" class="easyui-combobox iniTcompanyType" data-options="height:30,ditable:false,valueField:'id',textField:'companyType',url:'parameter/companytypeEx'" />
		

		</td>
		<td class="tdRight">企业性质:</td>
		<td><input value="${company.companyProperty.id}"  name="companyProperty.id" class="easyui-combobox iniTcompanyProperty" data-options="height:30,editable:false,valueField:'id',textField:'companyProperty',url:'parameter/propertyEx'" /></td>
	</tr>
	<tr>
		<td class="tdRight">经济类型:</td>
		<td class="bj_belu"><input value="${company.companyEconomyType.id}" name="companyEconomyType.id" class="easyui-combobox " data-options="height:30,editable:false,valueField:'id',textField:'companyEconomyType',url:'parameter/economytypeEx'" /></td>
	...
	<tr>
			...
			<td><input name="area.code" class="easyui-combobox iniTcompanyProperty"  value="${company.area.code}" data-options="height:30,editable:false,valueField:'code',textField:'name',url:'parameter/getArea'" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tdCenter" colspan="4">
				<a href="javascript:basicFile.editCompany();" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
