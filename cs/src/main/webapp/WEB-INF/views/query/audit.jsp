...
<script type="text/javascript">
	...
	queryAudit.openAudit = function(index) {
		esd.common.defaultOpenWindowEx("年审查看", 920, 600, "${contextPath}/security/audits/edit/" + index + "/1");
	};
	/*
	 * 获取企业基本档案函数
	 */
...
<div id="queryAuditBoolbar">
	<div class="paramsTab">
		...
		<div class="findBut">
			<a href="javascript:queryAudit.findData()" class="easyui-linkbutton" iconCls="icon-search">查询</a> <a href="javascript:queryAudit.init()" class="easyui-linkbutton" iconCls="icon-redo">重置</a>
