	...
	<div style="border: #95B8E7 1px solid; width: 900px;">
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="300" colspan="2"><input name="company.companyCode" class="bj_belu2 readonly" type="text" value="${entity.company.companyCode}" /> <input type="hidden" id="companyId"
					name="company.id" value="${entity.company.id}" /> <input type="hidden" name="year" id="year" value="${entity.year}" /> <input type="hidden" name="company.version" value="${entity.company.version}" />
				</td>
				<td>年审年度:</td>
				<td><input class="readonly" type="text" value="${entity.year}" />
				</td>
				<td>未审年度:</td>
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td><input id="yuDingCanJiRen" name="companyPredictTotal" value="${entity.companyPredictTotal }" title="预定残疾职工人数" class="readonly" onblur="initAudit.jisuan()" />
				</td>
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="100">备注:</td>
				<td colspan="8"><textarea class="readonly" name="remark" rows="2" cols="90" style="height: 60px;">${entity.remark }</textarea>
				</td>
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td colspan="3"><textarea class="readonly" name="initAuditComment" rows="3" cols="45" style="height: 60px;">${entity.initAuditComment}</textarea>
				</td>
				<td width="100">复审意见:</td>
				<td colspan="3"><textarea name="verifyAuditComment" class="warn" rows="3" cols="45" style="height: 60px;">${entity.verifyAuditComment}</textarea>
				</td>
			</tr>
			<tr>
				<td class="">初审日期:</td>
