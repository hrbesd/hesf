...
<form id="form" action="${contextPath }/security/audits/save" method="post" style="margin-top: 5px; margin-left: 2px;">
	...
	<div style="border: #95B8E7 1px solid; width: 900px;">
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>未审年度:</td>
				<td><input type="text" readonly="readonly" <c:if test="${unAudityearNum==0}">value="无"</c:if> <c:if test="${unAudityearNum>0}">value="${unAudityear}" class="error"</c:if> /></td>
			</tr>
			<tr>
				<td>企业名称:</td>
				<td colspan="2"><input class="readonly" name="company.companyName" type="text" value="${entity.company.companyName}" />
				</td>

				<td style="width:100px;">税务代码:</td>
				<td width="180"><input class="readonly" name="company.companyTaxCode" type="text" value="${entity.company.companyTaxCode}" />
				</td>
				<td width="100">年龄超标</td>
				<td><input readonly="readonly" type="text" value="${ageEx }" <c:if test="${ageEx>0}">class="error"</c:if> />
				</td>
			</tr>
			...
			<tr>
				...
				<td width="199"><input class="readonly" name="company.companyLegal" class="bj_belu3" type="text" value="${entity.company.companyLegal}" /></td>
				<td>组织机关代码证:</td>
				<td><input class="readonly" name="company.companyOrganizationCode" class="bj_belu3" type="text" value="${entity.company.companyOrganizationCode}" />
				</td>
				<td>企业性质:</td>
				<td>
					<!--
			...
			<tr>
				<td>联系人 :</td>
				<td><input class="readonly" name="company.companyContactPerson" class="bj_belu3" type="text" value="${entity.company.companyContactPerson}" />
				</td>
				<td>电话号码:</td>
				<td><input class="readonly" name="company.companyPhone" class="bj_belu3" type="text" value="${entity.company.companyPhone}" />
				</td>
				<td>经济类型:</td>
				<td>
					<!-- 
			...
			<tr>
				<td>手机号码:</td>
				<td><input class="readonly" name="company.companyMobile" class="bj_belu3" value="${entity.company.companyMobile}" />
				</td>
				<td>企业地址:</td>
				<td colspan="6"><input class="readonly" name="company.companyAddress" value=${entity.company.companyAddress } />
				</td>

			</tr>
			<tr>
				<td>开户银行:</td>
				<td><input class="readonly" name="company.companyBank" class="bj_belu3" value=${entity.company.companyBank } />
				</td>
				<td>银行账号:</td>
				<td><input class="readonly" name="company.companyBankAccount" class="bj_belu3" value=${entity.company.companyBankAccount } />
				</td>
				<td>邮政编码:</td>
				<td><input class="readonly" name="company.companyZipCode" value=${entity.company.companyZipCode } />
				</td>
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td rowspan="3" style="vertical-align: bottom"><input name="company.companyEmpTotal" title="在职员工总数" id="zaiZhiYuanGongZongShu" type="text" value="${entity.company.companyEmpTotal }"
					 class="readonly" style="border-top: #95B8E7 2px solid;" onblur="verifyAudit.jisuan()" />
				</td>
				<td width="97">应按排数:</td>
			...
			<tr>
				...
				<td><input id="yuDingCanJiRen" name="company.companyPredictTotal" value="${entity.company.companyPredictTotal }" title="预定残疾职工人数" class="readonly" onblur="verifyAudit.jisuan()" />
				</td>
			</tr>
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="100"><input id="jianJiaoJinE" type="text" class="warn" name="reductionAmount" value="${entity.reductionAmount}" onblur="verifyAudit.jisuan()" />
				</td>
				<td width="99">补缴金额:</td>
				<td><input id="buJiaoJinE" type="text" class="warn" name="complementAmount" value="${entity.complementAmount }" onblur="verifyAudit.jisuan()" />
				</td>

				<td width="91">是否免交:</td>
				<td><select id="cc" style="font-size: 12px;" class="easyui-combobox" name="isExempt" data-options="value:1,width:100,panelHeight:80,height:30,editable:false">
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="100">备注:</td>
				<td colspan="6"><textarea name="remark" rows="2" cols="90" class="readonly">${entity.remark }</textarea>
				</td>
	...
	<div style="text-align: center;margin-top: 10px;">
	  <a href="javascript:verifyAudit.back();" class="easyui-linkbutton"
