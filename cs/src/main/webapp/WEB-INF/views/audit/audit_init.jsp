...
<form id="form" action="${contextPath }/security/audits/save" method="post" style="margin-top: 5px; margin-left: 2px;">
	...
	<div style="border: #95B8E7 1px solid; width: 900px;">
		...
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="100">备注:</td>
				<td colspan="8"><textarea name="remark" rows="2" style="height: 60px;">${entity.remark }</textarea>
				</td>
			</tr>
		</table>
		<!-- 年审企业表格  第六部分(意见栏) -->
		<table class="company-examined" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td colspan="3"><textarea name="initAuditComment" rows="3" cols="45" style="height: 60px;">${entity.initAuditComment}</textarea>
				</td>
				<td width="100">复审意见:</td>
				<td colspan="3"><textarea class="readonly" rows="3" cols="45" style="height: 60px;">${entity.verifyAuditComment}</textarea>
				</td>
			</tr>
			<tr>
				<td class="">初审日期:</td>
