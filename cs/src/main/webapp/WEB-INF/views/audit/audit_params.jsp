			...
			<table class="parameterTab">
				<tr>
					...
					<td><input class="easyui-validatebox" required="true" name="year" type="text" value="${params.year}" /> <input class="easyui-validatebox" name="version" type="hidden"
						value="${params.version}" /> <input class="easyui-validatebox" name="id" type="hidden" value="${params.id}" />
					</td>
				</tr>
				<tr>
					<td>所属地区:</td>
					...
					<td>滞纳金开始日期:</td>
					<td>
					<fmt:formatDate value="${params.auditDelayDate}" type="date" dateStyle="long" pattern="yyyy-MM-dd" var="auditDelayDate" />
				...
				<tr>
					<td>安置比例(%):</td>
					<td><input class="easyui-validatebox" name="putScale" type="text" required="true" value="${params.putScale}" />
					</td>
					<td>滞纳金征收比率(%):</td>
					<td><input class="easyui-validatebox" name="auditDelayRate" type="text" required="true" value="${params.auditDelayRate}" />
					</td>
					<td>职工退休年龄(男)：</td>
					<td><input class="easyui-validatebox" name="retireAgeMale" type="text" required="true" value="${params.retireAgeMale}" />
					</td>
				</tr>
				<tr>
					<td>计算基数:</td>
					<td><input class="easyui-validatebox" name="averageSalary" type="text" required="true" value="${params.averageSalary}" />
					</td>
					<td>支付截至日期:</td>
					...
					<td>职工退休年龄(女)：</td>
					<td><input class="easyui-validatebox" name="retireAgeFemale" type="text" required="true" value="${params.retireAgeFemale }" />
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
