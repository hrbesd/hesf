...
<script type="text/javascript">
	...
	var saveWithOutPic = function(){
		...
		if(params != null && params != undefined){
			$.ajax({
				url : '${contextPath}/security/worker/editWorkerTemp',
				type : 'post',
				data : {
					'id':params.id, //id
					'workerName':params.workerName, //姓名
	 	...
	 	<form id="addWorkerForm" action="#" method="post" class="addWorkerForm">
			...
			<table id="company_information" align="center">
				...
				<tr>
					...
					<td class="">残疾类别:</td>
					<td>
						<input class="easyui-combobox" type="text" name="workerHandicapType.id" id="workerHandicapType" value="${worker.workerHandicapType }"
					...
					<td class="">残疾等级:</td>
					<td>
						<input class="easyui-combobox" type="text" name="workerHandicapLevel.id" id="workerHandicapLevel" value="${worker.workerHandicapLevel }"
