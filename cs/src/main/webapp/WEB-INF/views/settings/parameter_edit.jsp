			...
			<table class="parameterTab">
				<tr>
					...
					<td ><input class="easyui-validatebox" required="true" name="year" type="text" value="${entity.year}" /> <input class="easyui-validatebox" name="version" type="hidden"
						value="${entity.version}" /> <input class="easyui-validatebox" name="id" type="hidden" value="${entity.id}" /></td>
				</tr>
				<tr>
					<td>所属地区:</td>
				...
				<tr>
					<td>安置比例(%):</td>
					<td><input class="easyui-validatebox" name="putScale" type="text" required="true" value="${entity.putScale}" /></td>
					<td>滞纳金征收比率(%):</td>
					<td><input class="easyui-validatebox" name="auditDelayRate" type="text" required="true" value="${entity.auditDelayRate}" /></td>
					<td>职工退休年龄(男)：</td>
					<td><input class="easyui-validatebox" name="retireAgeMale" type="text" required="true" value="${entity.retireAgeMale}" /></td>
				</tr>
				<tr>
					<td>计算基数:</td>
					<td><input class="easyui-validatebox" name="averageSalary" type="text" required="true" value="${entity.averageSalary}" /></td>
					<td>支付截至日期:</td>
					<td>
					<fmt:formatDate value="${entity.payCloseDate}" type="date" dateStyle="long" pattern="yyyy-MM-dd" var="date" />
					<input class="easyui-datebox easyui-validatebox" name="payCloseDate" data-options="required:false,showSeconds:false" value="${date}" style="width:150px" /></td>
					<td>职工退休年龄(女)：</td>
					<td><input class="easyui-validatebox" name="retireAgeFemale" type="text" required="true" value="${entity.retireAgeFemale }" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
