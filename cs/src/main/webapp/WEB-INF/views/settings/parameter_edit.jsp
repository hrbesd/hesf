	...
	<div style="margin-top: 20px; margin-left: 20px;">
		<form id="form" action="${contextPath}/security/settings/yearAuditParameter/update" method="post">
			<table class="parameterTab">
				<tr>
					<td width="100">年度:</td>
					<td style="width: 200px;"><input class="easyui-validatebox" required="true" name="year" type="text" value="${entity.year}" />
			...
			<table style="margin-top: 10px; margin-left: 20px;">
				...
				<tr>
					<td></td>
					<td colspan="3"><a href="javascript:parameter_edit.update();" class="easyui-linkbutton" iconCls="icon-ok">更新</a> <a href="javascript:user_detail.submit();" class="easyui-linkbutton"
